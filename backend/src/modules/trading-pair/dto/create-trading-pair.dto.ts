...
export class CreateTradingPairDto {
  @ApiProperty({ example: 'EURUSD', description: 'Unique trading pair symbol' })
  @IsString()
  @IsNotEmpty()
  symbol: string;

  @ApiProperty({ example: 'EUR', description: 'Base asset of the pair' })
  @IsString()
  @IsNotEmpty()
  baseAsset: string;

  @ApiProperty({ example: 'USD', description: 'Quote asset of the pair' })
  @IsString()
  @IsNotEmpty()
  quoteAsset: string;
